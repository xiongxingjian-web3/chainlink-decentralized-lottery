// 在这里存放你的合约地址和 ABI
export const contractAddress = "0xE278C481344b60Cee21F9bCD7591ECA8d05cd234";
export const raffleAbi = [
  ...
  { inputs: [], name: "Raffle_InvalidRandomWords", type: "error" },
  { inputs: [], name: "Raffle_NoPlayersEntered", type: "error" },
  { inputs: [], name: "Raffle_NotEnoughTimePassed", type: "error" },
  { inputs: [], name: "Raffle_RaffleNotOpen", type: "error" },
  { inputs: [], name: "Raffle_SendMoreToEnterRaffle", type: "error" },
